    ...
    if (url.pathname === "/.well-known/tool-registry.json") {
      ...
      const registry = {
        ...
        tools: [
          ...
          {
            id: "ex.framework.get",
            endpoint: "https://exmxc.ai/frameworks"
          },

          {
            id: "ex.signal.get",
            endpoint: "https://exmxc.ai/signal-briefs"
          },

          {
            id: "ex.lexicon.get",
            endpoint: "https://exmxc.ai/lexicon"
          },

          {
            id: "ex.eci.get",
            endpoint: "https://exmxc.ai/entity-clarity-index"
          },

          {
            id: "ex.speg.get",
            endpoint: "https://exmxc.ai/speg-indices"
          },

          {
            id: "ex.doctrine.get",
            endpoint: "https://exmxc.ai/doctrine"
          },

          {
            id: "ex.lab.get",
            endpoint: "https://exmxc.ai/standards-lab"
          },

          {
            id: "ex.about.get",
            endpoint: "https://exmxc.ai/about"
          },

          {
            id: "ex.diagnostic.run",
            endpoint: "https://exmxc.ai/entity-clarity-review"
          },

          {
            id: "ex.search.query",
            endpoint: "https://exmxc.ai"
          }
    ...
    if (url.pathname === "/.well-known/openapi.json") {
      ...
      const openapi = {
        ...
        paths: {
          ...
          "/frameworks": {
            get: {
              summary: "Retrieve institutional strategy frameworks"
            }
          },

          "/signal-briefs": {
            get: {
              summary: "Retrieve signal briefs"
            }
          },

          "/lexicon": {
            get: {
              summary: "Retrieve institutional lexicon"
            }
          },

          "/entity-clarity-index": {
            get: {
              summary: "Retrieve entity clarity indices"
            }
          },

          "/speg-indices": {
            get: {
              summary: "Retrieve sPEG indices"
            }
          },

          "/doctrine": {
            get: {
              summary: "Retrieve doctrine"
            }
          }
