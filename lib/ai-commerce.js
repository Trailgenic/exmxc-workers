...
export function buildAiCommerceRelease(episodes, { releaseId, asOf, benchmarks = [], searchInterest, selectionRunCount = 0, notes = '' }) {
  ...
  return {
    ...
    benchmarks, ...(searchInterest ? { search_interest: searchInterest } : {}), notes
  };
}
