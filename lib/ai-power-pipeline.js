...
export function assembleVerifiedProfile(baseRelease, entityId, documents, verified, assessedAt) {
  ...
  for (const claim of verified.claims || []) {
    ...
    evidence.push({
      ...
      observation: { valid_from: nullableString(claim.valid_from), valid_through: nullableString(claim.valid_through), last_substantive_verification_at: nullableString(claim.last_substantive_verification_at) },
      locator,
      extract,
