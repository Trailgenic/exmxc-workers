...
export const BUILD = { version: "2.10.0", released: "2026-09-11" };
...
export const DATA_TOOLS = [
  ...
  },
  {
    ...
    title: "Run a Strategic Consequence Scenario",
    description:
      "Propagate one canonical counterfactual through the bundled Four Forces, AI Power, scarcity, and available Reality Gap layers. Returns conditional first-order advantage and pressure, second-order consequences, bottlenecks, assumptions, and confirming or invalidating signals.",
  ...
  },
  {
    ...
    description: "Collect page delivery, declared provider-purpose access policy, machine-readable identity evidence, an uncompleted Entity Clarity v2 review template, and a clearly labeled legacy website diagnostic for one public HTTPS URL.",
    route: "/audit/run",
    inputSchema: {
      type: "object",
      properties: {
...
export const SCHEMA_RESOURCES = [
  ...
  { id: "entity_clarity_evidence_v2", uri: "exmxc://schemas/entity_clarity_evidence_v2", name: "Entity Clarity Evidence v2 Pilot Schema", description: "Schema for collection status, declared provider-purpose access, review coverage, explicit unknowns, model-test status, and legacy diagnostic separation.", mimeType: "application/json", category: "schema", route: "/schemas/entity-clarity-evidence-v2", data: entityClarityEvidenceV2Schema, includeInDiscovery: true }
];
