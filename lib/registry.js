...
import consumerIntentObservationV1Schema from "../schema/consumer_intent_observation_v1.schema.json" with { type: "json" };
import consumerIntentReleaseV1Schema from "../schema/consumer_intent_release_v1.schema.json" with { type: "json" };
import {
...
export const BUILD = { version: "2.16.0", released: "2026-09-21" };
...
export const DATASETS = {
  consumer_intent_pulse_v1: {
    id: "consumer_intent_pulse_v1",
    route: "/consumer-intent/pulse",
    resourceUri: "exmxc://datasets/consumer-intent/pulse/v1",
    displayName: "Consumer Intent Pulse v1",
    description: "Versioned factor-level readings of observed digital consumer intent and wallet behavior. V1 publishes no arbitrary composite and returns insufficient_evidence below transparent coverage gates.",
    category: "longitudinal-instrument",
    data: CONSUMER_INTENT_LATEST,
    schemaRoute: "/schemas/consumer-intent-release-v1",
    schema: consumerIntentReleaseV1Schema
  },
  consumer_intent_methodology_v1: {
    id: "consumer_intent_methodology_v1",
    route: "/consumer-intent/methodology",
    resourceUri: "exmxc://methodologies/consumer-intent/v1",
    displayName: "Consumer Intent Graph Methodology v1",
    description: "Construct definition, factor ontology, publication gates, source policy, limitations, and validation plan for the Consumer Intent Graph.",
    category: "methodology",
    data: CONSUMER_INTENT_METHODOLOGY
  },
  consumer_intent_releases_v1: {
    id: "consumer_intent_releases_v1",
    route: "/consumer-intent/releases",
    resourceUri: "exmxc://datasets/consumer-intent/releases/v1",
    displayName: "Consumer Intent Pulse Release Ledger",
    description: "Immutable dated Consumer Intent Pulse releases and their methodology lineage.",
    category: "release-ledger",
    data: CONSUMER_INTENT_RELEASES
  },
  consumer_intent_entities_v1: {
    id: "consumer_intent_entities_v1",
    route: "/consumer-intent/entities",
    resourceUri: "exmxc://registries/consumer-intent/entities/v1",
    displayName: "Consumer Intent Entity Registry v1",
    description: "Consumer-facing brands and retailers connected to public-company parents and tickers.",
    category: "registry",
    data: CONSUMER_INTENT_ENTITIES
  },
  consumer_intent_categories_v1: {
    id: "consumer_intent_categories_v1",
    route: "/consumer-intent/categories",
    resourceUri: "exmxc://registries/consumer-intent/categories/v1",
    displayName: "Consumer Intent Category Taxonomy v1",
    description: "Extensible sector, category, and subcategory hierarchy for consumer observations.",
    category: "ontology",
    data: CONSUMER_INTENT_CATEGORIES
  },
  ai_power_rankings: {
...
export const DATA_TOOLS = [
  {
    id: "ex.consumer_intent.pulse.get",
    title: "Get Consumer Intent Pulse",
    description: DATASETS.consumer_intent_pulse_v1.description,
    route: DATASETS.consumer_intent_pulse_v1.route,
    inputSchema: {
      type: "object",
      properties: {
        factor: { type: "string", enum: ["wallet_stress", "purchase_intent", "purchase_deferral", "trade_down", "deal_sensitivity", "discretionary_appetite"] },
        ticker: { type: "string", description: "Optional public-company ticker, such as NKE or TJX." },
        release: { type: "string", description: "Exact immutable release identifier; omit for latest." }
      },
      additionalProperties: false
    },
    openApiParameters: ["factor", "ticker", "release"]
  },
  {
    id: "ex.consumer_intent.entity.get",
    title: "Get Consumer Intent Company Lens",
    description: "Resolve a supported brand, retailer, company, or ticker and return its parent-company mapping, dated factor evidence, substitutions, and explicit coverage status.",
    route: "/consumer-intent/entity",
    inputSchema: {
      type: "object",
      properties: { query: { type: "string", description: "Brand, retailer, company, or ticker." } },
      required: ["query"],
      additionalProperties: false
    },
...
export const CONTENT_LINKS = [
  { id: "ex.consumer_intent.page", title: "Consumer Intent", description: "Observed digital consumer intent and wallet behavior by factor, category, and company.", url: "https://www.exmxc.ai/consumer-intent" },
  { id: "ex.consumer_intent.methodology", title: "Consumer Intent Methodology", description: "Ontology, evidence gates, limitations, versioning, and validation plan.", url: "https://www.exmxc.ai/consumer-intent-methodology" },
...
export const SCHEMA_RESOURCES = [
  { id: "consumer_intent_observation_v1", uri: "exmxc://schemas/consumer-intent-observation/v1", name: "Consumer Intent Observation v1 Schema", description: "Schema for normalized, attributable consumer intent and wallet-behavior observations.", mimeType: "application/json", category: "schema", route: "/schemas/consumer-intent-observation-v1", data: consumerIntentObservationV1Schema, includeInDiscovery: true },
  { id: "consumer_intent_release_v1", uri: "exmxc://schemas/consumer-intent-release/v1", name: "Consumer Intent Pulse Release v1 Schema", description: "Schema for immutable factor, category, entity, and substitution readings with explicit evidence status.", mimeType: "application/json", category: "schema", route: "/schemas/consumer-intent-release-v1", data: consumerIntentReleaseV1Schema, includeInDiscovery: true },
