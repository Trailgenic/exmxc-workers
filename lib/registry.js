...
export const BUILD = { version: "2.8.0", released: "2026-07-30" };
...
export const SCHEMA_RESOURCES = [
  ...
  { id: "entity_registry", uri: "exmxc://schemas/entity_registry", name: "Entity Registry Schema", description: "Stable-identifier schema for the Entity Clarity panel.", mimeType: "application/json", category: "schema", route: "/schemas/entity-registry", data: entityRegistrySchema, includeInDiscovery: true },
