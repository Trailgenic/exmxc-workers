...
export const BUILD = { version: "2.13.0", released: "2026-09-11" };
    ...
    resolver: dataset.id === "entities"
      ...
      : dataset.id === "speg"
        ...
        : dataset.id === "ai_power_profiles_v2"
          ? "aiPowerProfilesV2"
          : undefined,
    data: ["entities", "speg", "ai_power_index", "four_forces", "ai_power_profiles_v2"].includes(dataset.id) ? undefined : dataset.data,
    includeInDiscovery: true
  })),
  ...SCHEMA_RESOURCES,
