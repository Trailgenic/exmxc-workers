...
export const BUILD = { version: "2.11.0", released: "2026-09-11" };
...
export const DATA_TOOLS = [
  ...
  },
  {
    ...
    description: "Collect page delivery, declared provider-purpose access policy, machine-readable identity evidence, a deterministic five-dimension Entity Clarity v2.1 score when assessable, and a clearly labeled legacy website diagnostic for one public HTTPS URL.",
    route: "/audit/run",
    inputSchema: {
      type: "object",
      properties: {
...
export const SCHEMA_RESOURCES = [
  ...
  { id: "entity_clarity_evidence_v2", uri: "exmxc://schemas/entity_clarity_evidence_v2", name: "Automated Entity Clarity Evidence v2.1 Pilot Schema", description: "Schema for collection status, declared provider-purpose access, deterministic five-dimension Entity Clarity, explicit unknowns, model-test status, and legacy diagnostic separation.", mimeType: "application/json", category: "schema", route: "/schemas/entity-clarity-evidence-v2", data: entityClarityEvidenceV2Schema, includeInDiscovery: true }
];
