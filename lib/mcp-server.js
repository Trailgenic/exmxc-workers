...
import { getDatasetIndex, getEntities, getIndex, getSpeg, TOOL_HANDLERS } from "./queries.js";
...
export function resolveMcpResource(uri) {
  ...
  if (resource.resolver === "index") return getIndex(); if (resource.resolver === "entities") return getEntities({}); if (resource.resolver === "speg") return getSpeg({});
